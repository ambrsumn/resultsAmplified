                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-12">
                                <h1 class="tit" align="center" style="color:brown; font-size:3rem; ">Results Amplified..</h1>
                            </div>
                        </div>
                        <!-- /.row -->
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                ...
                                                $qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status from tblstudents where tblstudents.RollId=:rollid";
